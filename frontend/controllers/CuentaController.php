...
//                }
    ...
    public function actionActualizarTodosLosPerfiles() {
        if (Yii::$app->user->can("Administrador")) {
            $modelImagenPerfil = ImagenPerfil::find()->all();

            foreach ($modelImagenPerfil as $unaImagenPerfil) {

                if ($unaImagenPerfil != null) {
                    $rutaImagenPerfil = $unaImagenPerfil->rutaImagenPerfil;
                    $rutaImagenPerfil = substr($rutaImagenPerfil, 1);
                    ...
                    if (file_exists($rutaImagenPerfil)) {
                        ...
                        if (rename($rutaImagenPerfil, $nuevaRutaImagen)) {
                            ...
                            echo "<br> Imagen de Perfil Actualizada <br>";
                        }
                    } else {
                        echo "toy juera";
                    }
