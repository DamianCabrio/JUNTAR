...
/**
 * RespuestaFileSearch represents the model behind the search form of `frontend\models\RespuestaFile`.
 */
class RespuestaFileSearch extends RespuestaFile
{
    ...
    {
        return [
            [['id', 'idpregunta', 'idinscripcion'], 'integer'],
            [['respuesta'], 'safe'],
        ];
    }
