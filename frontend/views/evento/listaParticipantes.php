...
function obtenerFecha($estado)
{
    ...
    if ($estado['user_estado'] == 1) {
        $obtener = date("d-m-Y", strtotime($estado['user_fechaPreInscripcion']));
    }
    if ($estado['user_estado'] == 2) {
        $obtener = date("d-m-Y", strtotime($estado['user_fechaInscripcion']));
    }
...
function obtenerEstado($dato)
{
    ...
    if ($dato['user_estado'] == 0) {
        $obtener = "preinscripto";
    }
    if ($dato['user_estado'] == 1 && $dato['user_acreditacion'] == 0) {
        $obtener = "inscripto";
    }
    if ($dato['user_estado'] == 1 && $dato['user_acreditacion'] == 1) {
        $obtener = "acreditado";
    }
    if ($dato['user_estado'] == 2) {
        $obtener = "anulado";
    }
