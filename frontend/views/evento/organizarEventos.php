                        ...
                        <div class="col-sm-12 col-md-4 mb-3">
                            ...
                            <select name="estadoEvento" class="custom-select custom-select-lg"
                                ...
                                <option <?= (isset($_GET["estadoEvento"]) && $_GET["estadoEvento"] == 0) ? "selected" : "" ?>
                                        value="0">Estado Activo
                                </option>
                                <option <?= (isset($_GET["estadoEvento"]) && $_GET["estadoEvento"] == 1) ? "selected" : "" ?>
                                        value="1">Estado Borrador
                                </option>
                                <option <?= (isset($_GET["estadoEvento"]) && $_GET["estadoEvento"] == 2) ? "selected" : "" ?>
                                        value="2">Estado Finalizado
                                </option>
                            </select>
                        </div>
