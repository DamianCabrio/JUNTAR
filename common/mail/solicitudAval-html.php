...
<div class="request">
    ...
    <p>El usuario <b><?= $organizer->apellido . " " . $organizer->nombre ?></b> organizador del Evento
        <b><?= $event->nombreEvento ?></b>
        solicita la aprobación para que sea un evento avalado por la Facultad de Informática - UNComa. </p>
    <div class=""
         style="width: 50%; background-color: #212529; border-radius: 15px; padding: 5px; padding-bottom: 60px;">
        <ul style="list-style: none;">
            ...
            <li style="background-color: #DDDDDD; border-radius: 6px; margin: 7px; padding: 5px;">
                <b>Fecha de Inicio:</b> <?= Yii::$app->formatter->asDateTime($event->fechaInicioEvento, "php:d-m-Y") ?>
            </li>
            <li style="background-color: #DDDDDD; border-radius: 6px; margin: 7px; padding: 5px;">
                <b>Fecha de
                    Finalización:</b> <?= Yii::$app->formatter->asDateTime($event->fechaFinEvento, "php:d-m-Y") ?></li>
            <li style="background-color: #DDDDDD; border-radius: 6px; margin: 7px; padding: 5px;">
