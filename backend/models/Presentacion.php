...
class Presentacion extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idEvento'], 'integer'],
            [['horaInicioPresentacion'], 'safe'],
            [['diaPresentacion'], 'common\components\PresentationDateValidator'],
            [['horaFinPresentacion'], 'common\components\PresentationHoursValidator'],
    ...
    {
        return $this->hasOne(Usuario::className(), ['idUsuario' => 'idExpositor'])->viaTable('presentacion_expositor', ['idPresentacion' => 'idPresentacion']);
    }
