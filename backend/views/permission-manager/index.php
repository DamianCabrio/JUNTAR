                ...
                <div class="col-md-3 col-sm-12" id="roleDiv">
                    ...
                    foreach ($roles as $index => $rol) {
                        if ($rol['name'] != "Administrador") {
                            ?>
                            <div class="<?php echo 'order-' . Html::encode($index); ?> roles"
                                    ...
                                    <dfn>
                                        <abbr title="<?php echo Html::encode($unPermiso['description']); ?>">
                                            <img src="icons/question-circle.svg"
                                                 class="d-none d-md-inline-block filter-blue fixed-right" role="img"
                                                 width="20" height="20" style="margin: 0px 10px 0 20px;">
                                        </abbr>
                                    </dfn>
