                    ...
                    <div class="row justify-content-center">
                        ...
                        <a class="btn col-md-6 col-sm-12 p-0 mb-3"
                           href="<?= Html::encode(Url::to(['permission/create-permiso', 'entorno' => 'frontend'])) ?>">
                            <div class="card text-center bg-light d-block p-0">
                                <h5 class="card-header <?php if ($entorno == 'frontend') {
                                    echo "pinkish_bg text-white";
                                } ?>">
                                    <img class="<?php if ($entorno == 'frontend') {
                                        echo "filter-white";
