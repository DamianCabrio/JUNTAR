...
('evento/evento-cargado', 2, 'Evento cargado', NULL, NULL, 1592273142, 1592273142),
...
('presentacion/delete', 2, 'Borrar presentacion', NULL, NULL, 1592276047, 1592276047),
('presentacion/mostrar-presentacion', 2, 'Permite mostrar una presentacion', NULL, NULL, 1592330387, 1592330387),
('presentacion/update', 2, 'Actualizar presentacion', NULL, NULL, 1592276038, 1592276180),
('presentacion/view', 2, 'Mostrar presentacion', NULL, NULL, 1592273163, 1592274967),
...
('Administrador', 'permission-manager/index2'),
...
('Organizador', 'evento/evento-cargado'),
...
('Organizador', 'presentacion/mostrar-presentacion'),
